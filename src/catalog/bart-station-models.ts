...
// ELEVATOR IDS ARE BART'S REAL ASSET IDS (2026-07-20). Every externalId here
// (and in the 7 inline models in station-models.ts) is BART's own elevator
// asset id (format <stationAssetCode>-<n>, e.g. M16-63, W40-116), adopted from
// the ADA settlement's per-elevator inventory — Senior and Disability Action v.
// BART, 3:17-cv-01876 (N.D. Cal.), Exhibit F. See bart-data/bart-ada-settlement.md
// + settlement-elevator-inventory.json for provenance, the function/position
// legend (HYD-S street / HYD-P* platform / HYD-SP single-shaft / TRA-G garage /
// HYD-AMTRAK out-of-scope), and the 3-way reconciliation vs BART's live
// /accessible pages (which CONFIRMED every model's structure). CAVEATS: (1) these
// are asset-management ids, NOT the live cmd=elev feed ids (BART's advisory stays
// free-text station-level) — attribution is still by matchHints; the ids are for
// identity + validation. (2) Where a station has >=2 same-function elevators
// (per-direction platform pairs, twin street elevators), the id<->physical-side
...
export const BART_STATION_MODELS: StationModel[] = [
  ...
  // field survey + BART's own outage-options page agree exactly) ----
  {
    ...
    segments: [
      { id: "street-mezzanine", label: "Street to mezzanine", elevators: [{ externalId: "M16-62", label: "Market and Drumm — Street Elevator", matchHints: ["street"] }] },
      { id: "mezzanine-platform", label: "Mezzanine to platform", elevators: [{ externalId: "M16-63", label: "Platform Elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    internalNote: "Confirmed against TransitAccess's independent Muni field survey of this shared station (same 2-elevator, non-redundant structure).",
    segments: [
      { id: "street-mezzanine", label: "Street to mezzanine", elevators: [{ externalId: "M20-52", label: "Market and Sutter — Street Elevator", matchHints: ["street"] }] },
      { id: "mezzanine-platform", label: "Mezzanine to platform", elevators: [{ externalId: "M20-53", label: "Platform Elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    internalNote: "Confirmed against TransitAccess's independent Muni field survey of this shared station (same 2-elevator, non-redundant structure).",
    segments: [
      { id: "street-mezzanine", label: "Street to mezzanine", elevators: [{ externalId: "M30-54", label: "Market and Ellis — Street Elevator", matchHints: ["street"] }] },
      { id: "mezzanine-platform", label: "Mezzanine to platform", elevators: [{ externalId: "M30-55", label: "Platform Elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    internalNote: "Confirmed against TransitAccess's independent Muni field survey of this shared station (same 2-elevator, non-redundant structure).",
    segments: [
      { id: "street-mezzanine", label: "Street to mezzanine", elevators: [{ externalId: "M40-56", label: "U.N. Plaza — Street Elevator", matchHints: ["street"] }] },
      { id: "mezzanine-platform", label: "Mezzanine to platform", elevators: [{ externalId: "M40-57", label: "Platform Elevator", matchHints: ["platform"] }] },
    ],
  },
  ...
  // ---- Template: single elevator, no in-station backup (pure SPOF) ----
  {
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "M80-38", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "A50-6", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "BERY",
    note: "Single station elevator, no backup. BART's guidance: the nearest alternative is Milpitas station.",
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "S50-154", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "CAST",
    note: "Single station elevator, no backup. BART's guidance: the nearest alternative is Hayward station.",
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "L10-95", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform", label: "Platform elevator", elevators: [{ externalId: "W10-91", label: "Platform elevator", matchHints: ["platform"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "C60-21", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "L30-99", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "A90-13", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "M70-37", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "LAFY",
    note: "Single station elevator, no backup. BART's guidance: the nearest alternative is Orinda station.",
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "C30-16", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "R30-46", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "NCON",
    note: "Single station elevator, no backup. BART's guidance: the nearest alternative is Concord station.",
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "C70-92", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "C20-15", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "E20-158", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "C10-14", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "W30-104", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "SSAN",
    note: "Single station elevator, no backup. BART's guidance: the nearest alternative is Colma station.",
    segments: [{ id: "station", label: "Station elevator", elevators: [{ externalId: "W20-100", label: "Station elevator", matchHints: ["elevator"] }] }],
  },
  ...
  // ---- Template: two sequential elevators (street then platform), neither backed up ----
  {
    ...
    segments: [
      { id: "street-concourse", label: "Street to concourse", elevators: [{ externalId: "M50-33", label: "Street elevator", matchHints: ["street"] }] },
      { id: "concourse-platform", label: "Concourse to platform", elevators: [{ externalId: "M50-34", label: "Platform elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [
      { id: "street-concourse", label: "Street to concourse", elevators: [{ externalId: "M60-35", label: "Street elevator", matchHints: ["street"] }] },
      { id: "concourse-platform", label: "Concourse to platform", elevators: [{ externalId: "M60-36", label: "Platform elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [
      { id: "street-walkway", label: "Concourse to walkway", elevators: [{ externalId: "E30-159", label: "Street elevator (concourse to walkway)", matchHints: ["street"] }] },
      { id: "walkway-platform", label: "Walkway to platform", elevators: [{ externalId: "E30-160", label: "Platform elevator (walkway to platform)", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [
      { id: "street-concourse", label: "Street to concourse", elevators: [{ externalId: "R20-44", label: "Street elevator", matchHints: ["street"] }] },
      { id: "concourse-platform", label: "Concourse to platform", elevators: [{ externalId: "R20-45", label: "Platform elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [
      { id: "street-concourse", label: "Street to concourse", elevators: [{ externalId: "C80-93", label: "Street elevator", matchHints: ["street"] }] },
      { id: "concourse-platform", label: "Concourse to platform", elevators: [{ externalId: "C80-94", label: "Platform elevator", matchHints: ["platform"] }] },
    ],
  },
  {
    ...
    segments: [
      { id: "street-concourse", label: "Street to concourse", elevators: [{ externalId: "A10-140", label: "Street elevator", matchHints: ["street"] }] },
      { id: "concourse-platform", label: "Concourse to platform", elevators: [{ externalId: "A10-28", label: "Platform elevator", matchHints: ["platform"] }] },
    ],
  },
  ...
  // ---- Template: two elevators serving different directions, detour required ----
  {
    ...
    segments: [{ id: "platform-1", label: "Platform 1 (Richmond direction)", elevators: [{ externalId: "R50-164", label: "Platform 1 elevator (Richmond direction)", matchHints: ["platform 1","richmond"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "DELN",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 (Berryessa/SFO/Millbrae/Daly City direction)", elevators: [{ externalId: "R50-165", label: "Platform 2 elevator (Berryessa/SFO/Millbrae/Daly City direction)", matchHints: ["platform 2","berryessa","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 (Richmond direction)", elevators: [{ externalId: "R40-47", label: "Platform 1 elevator (Richmond direction)", matchHints: ["platform 1","richmond"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "PLZA",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 (Berryessa/SFO/Millbrae/Daly City direction)", elevators: [{ externalId: "R40-48", label: "Platform 2 elevator (Berryessa/SFO/Millbrae/Daly City direction)", matchHints: ["platform 2","berryessa","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 (Richmond/Millbrae/SFO/Daly City direction)", elevators: [{ externalId: "A20-1", label: "Platform 2 elevator", matchHints: ["platform 2","richmond","millbrae","sfo","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "FTVL",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "A20-2", label: "Platform 1 elevator", matchHints: ["platform 1","dublin","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "A60-7", label: "Platform 2 elevator", matchHints: ["platform 2","richmond","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "HAYW",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "A60-8", label: "Platform 1 elevator", matchHints: ["platform 1","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "C50-19", label: "Platform 1 elevator", matchHints: ["platform 1","antioch"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "PHIL",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "C50-20", label: "Platform 2 elevator", matchHints: ["platform 2","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "A40-4", label: "Platform 2 elevator", matchHints: ["platform 2","richmond","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "SANL",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "A40-5", label: "Platform 1 elevator", matchHints: ["platform 1","dublin","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "A80-11", label: "Platform 1 elevator", matchHints: ["platform 1","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "UCTY",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "A80-12", label: "Platform 2 elevator", matchHints: ["platform 2","richmond","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "C40-17", label: "Platform 1 elevator", matchHints: ["platform 1","antioch"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "WCRK",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "C40-18", label: "Platform 2 elevator", matchHints: ["platform 2","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "M10-26", label: "Platform 1 elevator", matchHints: ["platform 1","sfo","millbrae","daly city"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "WOAK",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "M10-27", label: "Platform 2 elevator", matchHints: ["platform 2","dublin","antioch","richmond","berryessa"] }] }],
  },
  {
    ...
    segments: [{ id: "platforms-2-4", label: "Platforms 2 & 4", elevators: [{ externalId: "K30-118", label: "Platforms 2 & 4 elevator", matchHints: ["platform","sfo","millbrae","daly city","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "MCAR",
    ...
    segments: [{ id: "platforms-1-3", label: "Platforms 1 & 3", elevators: [{ externalId: "K30-119", label: "Platforms 1 & 3 elevator", matchHints: ["platform","antioch","richmond"] }] }],
  },
  {
    ...
    segments: [{ id: "platform-1", label: "Platform 1 elevator", elevators: [{ externalId: "S40-150", label: "Platform 1 elevator (Berryessa direction)", matchHints: ["platform 1","berryessa"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "MLPT",
    ...
    segments: [{ id: "platform-2", label: "Platform 2 elevator", elevators: [{ externalId: "S40-151", label: "Platform 2 elevator (Millbrae/SFO/Daly City/Richmond direction)", matchHints: ["platform 2","millbrae","sfo","daly city","richmond","east bay"] }] }],
  },
  ...
  // ---- Special / more complex real layouts ----
  {
    ...
    segments: [{ id: "connector", label: "Connector platform elevator", elevators: [{ externalId: "H10-156", label: "Airport connector elevator", matchHints: ["elevator"] }] }],
  },
  {
    ...
    segments: [{ id: "station", label: "Station elevator (to BART platforms)", elevators: [{ externalId: "A30-3", label: "Station elevator" }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "COLS",
    ...
    segments: [{ id: "oac", label: "Elevator to Oakland Airport Connector", elevators: [{ externalId: "A30-30", label: "Oakland Airport Connector elevator", matchHints: ["airport", "connector", "oac"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "COLS",
  ...
  },
  {
    ...
    segments: [{ id: "platforms-1-2", label: "Platforms 1 & 2", elevators: [{ externalId: "M90-39", label: "Platforms 1 & 2 elevator", matchHints: ["platform","east bay"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "DALY",
    ...
    segments: [{ id: "platform-3", label: "Platform 3", elevators: [{ externalId: "M90-40", label: "Platform 3 elevator", matchHints: ["platform 3","sfo","millbrae"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "DALY",
  ...
  },
  {
    ...
    segments: [{ id: "street-platform-1", label: "Street to Platform 1 / bridge", elevators: [{ externalId: "A70-10", label: "Station elevator (street to Platform 1 and bridge)", matchHints: ["elevator"] }] }],
  },
  {
    systemId: "bart-bay-area",
    stationExternalId: "SHAY",
    ...
    segments: [{ id: "bridge-platform-2", label: "Bridge to Platform 2", elevators: [{ externalId: "A70-9", label: "Bridge to Platform 2 elevator", matchHints: ["platform 2"] }] }],
  },
  {
    ...
    segments: [
      { id: "platform-3", label: "Platform access (BART Platform 3 / Caltrain Platform 4 Northbound)", elevators: [
        ...
        { externalId: "W40-109", label: "BART Platform 3 elevator", matchHints: ["platform 3", "east bay", "sfo airport"] },
